...
function handSelection() {
    ...
    this.style.boxShadow = '0 0 0 4px #AE2A2F';
}
...
function publishResult(player, ai, result) {
    ...
    if (result === "win") {
        ...
        document.querySelector('[data-summary="who-win"]').style.color = "#AE2A2F";
    } else {
        document.querySelector('p.draws span').textContent = ++gameSummary.draws;
        document.querySelector('[data-summary="who-win"]').textContent = "Just a draw :\\";
